...
public class ListarVestuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_vestuario);
        aliaslista = findViewById(R.id.lvListarVestuario);
        inicializarFirebase();
        eventoDatabase();
        ...
        aliaslista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                novav.putExtra("Objeto", position);
                startActivity(novav);
            }
        });
    }
...
//    }
    ...
    private void eventoDatabase() {
        ...
        Query query1 = databaseReference.child("Familia");
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if(familia.getNecessidade().getNecessidade().equals("Vestuário"))
                    familias.add(familia);
                }
                familiaArrayAdapter = new ArrayAdapter<Familia>(ListarVestuario.this, android.R.layout.simple_list_item_1, familias);
...
//        });
    ...
    private void inicializarFirebase() {
        FirebaseApp.initializeApp(ListarVestuario.this);
