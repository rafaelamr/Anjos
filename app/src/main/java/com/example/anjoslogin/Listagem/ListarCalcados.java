...
public class ListarCalcados extends AppCompatActivity {
    ListView aliaslista;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_calcados);
        aliaslista = findViewById(R.id.lvListarCalcados);
        inicializarFirebase();
        eventoDatabase();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if(familia.getNecessidade().getNecessidade().equals("Calçados"))
                        familias.add(familia);
                }
                familiaArrayAdapter = new ArrayAdapter<Familia>(ListarCalcados.this, android.R.layout.simple_list_item_1, familias);
...
//        });
    ...
    private void inicializarFirebase() {
        FirebaseApp.initializeApp(ListarCalcados.this);
